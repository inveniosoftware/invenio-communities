...
class MemberRequestActionsEndpointLinks:
    ...
    def _available_action_ids_for_member(self, obj, context):
        ...
        can embed the logic to determine the available action here.
        ...
        # Not all requests have a type (i.e., Member was created before we started
        # storing the request type). In that case, because at this point we know the
        # Member is inactive, but has a request, the request must be an invitation.
