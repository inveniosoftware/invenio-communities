...
from invenio_records_resources.services.custom_fields.schema import CustomFieldsSchema, CustomFieldsSchemaUI
...
def init(app):
    ...
    cfs_registry = app.extensions["invenio-records-resources"].custom_fields_schema_registry
