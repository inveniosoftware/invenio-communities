...
def upgrade():
    ...
    # Set default value to False for existing group members (where group_id is not NULL)
    ...
    op.execute(
        ...
        .values(group_notification_enabled=False)
    )
    ...
    # Set default value to False for existing archived group invitations
